...
![DFIR Timeline](assets/images/DFIR-TimelineCreation-JP.png)

# スクリーンショット

## 起動

![Hayabusa 起動画面](assets/images/Startup.png)

## DFIRタイムラインのターミナル出力

![Hayabusa ターミナル出力画面](assets/images/Results.png)
...
![Hayabusa 検知頻度タイムライン出力画面](assets/images/DetectionFrequencyTimeline.png)

## 結果サマリ (Results Summary)

![Hayabusa 結果サマリ画面](assets/images/ResultsSummary.png)

## HTMLの結果サマリ (`-H`オプション)

![Hayabusa results summary](assets/images/HTML-ResultsSummary-1.png)

![Hayabusa results summary](assets/images/HTML-ResultsSummary-2.png)

![Hayabusa results summary](assets/images/HTML-ResultsSummary-3.png)
...
![Hayabusa Timeline Explorerでの解析](assets/images/TimelineExplorer-ColoredTimeline.png)

## Criticalアラートのフィルタリングとコンピュータごとのグルーピング

![Timeline ExplorerでCriticalアラートのフィルタリングとコンピュータグルーピング](assets/images/TimelineExplorer-CriticalAlerts-ComputerGrouping.png)
...
CSVのタイムラインをExcelやTimeline Explorerで分析する方法は[こちら](assets/images/CSV-AnalysisWithExcelAndTimelineExplorer-Japanese.pdf)で紹介しています。

CSVのタイムラインをElastic Stackにインポートする方法は[こちら](assets/images/ElasticStackImport/ElasticStackImport-Japanese.md)で紹介しています。

CSVのタイムラインをTimesketchにインポートする方法は[こちら](assets/images/TimesketchImport/TimesketchImport-Japanese.md)で紹介しています。
...
![Mac Error 1 JP](assets/images/MacOS-RunError-1-JP.png)

macOSの環境設定から「セキュリティとプライバシー」を開き、「一般」タブから「このまま許可」ボタンをクリックしてください。

![Mac Error 2 JP](assets/images/MacOS-RunError-2-JP.png)
...
![Mac Error 3 JP](assets/images/MacOS-RunError-3-JP.png)
...
![logon-summary successful logons screenshot](assets/images/LogonSummarySuccessfulLogons.png)
...
* 2023/03/14 Fukusuke Takahashi氏による[Hayabusa開発者向けRustパフォーマンスガイド](assets/images/RustPerformance-English.md)
...
* 2023/03/14 Fukusuke Takahashi氏による[Hayabusa開発者向けRustパフォーマンスガイド](assets/images/RustPerformance-Japanese.md)
